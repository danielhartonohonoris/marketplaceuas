      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              CircleAvatar(
                backgroundImage: AssetImage('image/headset.jpeg'),
                radius: 80,
              ),
              ...
              const SizedBox(height: 10),
              const Text(
                'Headset premium dengan kualitas suara yang bagus untuk pengalaman mendengarkan yang keren',
              ...
              Column(
                ...
                children: [
                  _buildFeatureItem('- Suara berkualitass tinggi'),
                  _buildFeatureItem('- Desain noise-cancelling'),
                  _buildFeatureItem('- Nyaman dipakai dalam waktu lama'),
                ],
              ),
              const SizedBox(height: 20),
            ],
