      ...
      body: ListView(
        children: [
          CardItem(
            ...
            title: 'Baju',
            description:
                'Baju adalah pakaian atau garmen yang dikenakan untuk menutupi tubuh manusia. Pakaian dapat terdiri dari berbagai macam jenis dan gaya, termasuk atasan, bawahan, dan aksesori tambahan seperti jaket, mantel, atau rok.',
            onBeliSekarang: () {
              setState(() {});
            },
          ),
          ...
          CardItem(
            ...
            description:
                'Celana dalam pria adalah pakaian intim yang dirancang khusus untuk menutupi area genital dan panggul. Celana dalam pria umumnya terbuat dari bahan yang lembut dan elastis, seperti katun, spandex, atau campuran bahan lainnya. Fungsi utama celana dalam adalah memberikan dukungan dan perlindungan pada area genital serta menjaga kebersihan.',
            onBeliSekarang: () {
              setState(() {});
            },
          ),
          ...
          CardItem(
            ...
            title: 'Gaun',
            description:
                'Gaun adalah pakaian yang umumnya terdiri dari potongan panjang yang mencakup bagian atas tubuh hingga pinggang atau pinggul dan kemudian meluas ke bagian bawah untuk menutupi kaki. Gaun dapat memiliki berbagai gaya, panjang, dan desain, membuatnya sesuai untuk berbagai acara dan kesempatan.',
            onBeliSekarang: () {
              setState(() {});
            },
          ),
          ...
          CardItem(
            ...
            title: 'Hijab',
            description:
                'Hijab adalah pakaian atau penutup kepala yang digunakan oleh beberapa wanita Muslim sebagai bagian dari penampilan berpakaian sesuai dengan ajaran agama Islam. Penggunaan hijab bervariasi dan dapat mencakup berbagai gaya dan desain, tetapi umumnya mencakup penutup kepala, leher, dan dada.',
            onBeliSekarang: () {
              setState(() {});
            },
          ),
          ...
          CardItem(
            ...
            title: 'Hoodie',
            description:
                'Hoodie adalah jenis pakaian yang memiliki kapuchon (hood) yang ditempatkan di bagian belakang dan biasanya dilengkapi dengan tali yang dapat disesuaikan. Hoodie umumnya terbuat dari bahan yang nyaman, seperti katun atau campuran bahan lainnya, dan sering memiliki kantong di bagian depan.',
            onBeliSekarang: () {
              setState(() {});
            },
          ),
          ...
          CardItem(
            ...
            title: 'Jeans',
            description:
                'Jeans adalah jenis celana yang terbuat dari bahan denim, yang merupakan kain yang sangat tahan lama dan kuat. Celana jenis ini biasanya memiliki potongan lurus atau sedikit menyempit, dan mereka sering memiliki jahitan yang khas di sepanjang sisi. Jeans awalnya dirancang sebagai pakaian kerja untuk para pekerja, terutama para penambang dan petani, namun seiring berjalannya waktu, jeans menjadi sangat populer di kalangan masyarakat umum dan menjadi salah satu pakaian kasual paling umum.',
            onBeliSekarang: () {
              setState(() {});
            },
          ),
          ...
          CardItem(
            ...
            title: 'Kupluk',
            description:
                'Kupluk adalah topi atau penutup kepala yang memiliki ekstensi berbentuk segitiga di bagian atas yang dapat meliputi leher, telinga, dan dahi. Kupluk sering kali memiliki ikat di bawah dagu untuk menjaga agar penutup kepala tetap di tempat, terutama dalam cuaca dingin atau berangin.',
            onBeliSekarang: () {
              setState(() {});
            },
          ),
